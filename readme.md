...
```powershell
Export : mysqldump -u root -p db > db.sql
...
OR
certbot certonly --noninteractive --agree-tos --cert-name slickstack -d SITE_TLD -d www.SITE_TLD --register-unsafely-without-email --webroot -w /var/www/html/SITE_TLD
```
